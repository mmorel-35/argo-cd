...
const file_server_settings_settings_proto_rawDesc = "" +
	"\n" +
	"\x1eserver/settings/settings.proto\x12\acluster\x1a\x14gogoproto/gogo.proto\x1a\x1cgoogle/api/annotations.proto\x1aLgithub.com/argoproj/argo-cd/v3/pkg/apis/application/v1alpha1/generated.proto\x1a@github.com/argoproj/argo-cd/v3/server/settings/oidc/claims.proto\"\x0f\n" +
	"\rSettingsQuery\"\xb0\r\n" +
	"\bSettings\x12\x19\n" +
	"\x03url\x18\x01 \x01(\tB\a\xe2\xde\x1f\x03URLR\x03url\x120\n" +
	"\tdexConfig\x18\x02 \x01(\v2\x12.cluster.DexConfigR\tdexConfig\x12C\n" +
	"\n" +
	"oidcConfig\x18\x03 \x01(\v2\x13.cluster.OIDCConfigB\x0e\xe2\xde\x1f\n" +
	"OIDCConfigR\n" +
	"oidcConfig\x12 \n" +
	...
	"\x0eadditionalUrls\x18\x1b \x03(\tB\x12\xe2\xde\x1f\x0eAdditionalURLsR\x0eadditionalUrls\x12(\n" +
	...
	"\x04type\x18\x02 \x01(\tR\x04type\"\xc5\x03\n" +
	"\n" +
	"OIDCConfig\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x16\n" +
	"\x06issuer\x18\x02 \x01(\tR\x06issuer\x12(\n" +
	"\bclientID\x18\x03 \x01(\tB\f\xe2\xde\x1f\bClientIDR\bclientID\x121\n" +
	"\vcliClientID\x18\x04 \x01(\tB\x0f\xe2\xde\x1f\vCLIClientIDR\vcliClientID\x12\x16\n" +
	"\x06scopes\x18\x05 \x03(\tR\x06scopes\x12_\n" +
	"\ridTokenClaims\x18\x06 \x03(\v2&.cluster.OIDCConfig.IdTokenClaimsEntryB\x11\xe2\xde\x1f\rIDTokenClaimsR\ridTokenClaims\x12:\n" +
