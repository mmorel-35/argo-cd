...
func (s *Server) Get(ctx context.Context, _ *settingspkg.SettingsQuery) (*settingspkg.Settings, error) {
	...
	// IdTokenClaims) use protoc-gen-go camelCase naming, which differs from Go initialism
	// conventions. These names are generated by protoc-gen-go from the .proto field names
	// once gogo/protobuf customname options are removed. They will replace the previous
	// gogo-generated names (URL, AdditionalURLs, OIDCConfig, ClientID, CLIClientID,
	// IDTokenClaims) after `make protogen` is run.
