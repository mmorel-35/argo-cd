...
func TestUpdateCluster_RejectInvalidParams(t *testing.T) {
	...
	db.EXPECT().ListClusters(mock.Anything).RunAndReturn(
		func(_ context.Context) (*v1alpha1.ClusterList, error) {
	...
	db.EXPECT().UpdateCluster(mock.Anything, mock.Anything).RunAndReturn(
		func(_ context.Context, c *v1alpha1.Cluster) (*v1alpha1.Cluster, error) {
	...
	db.EXPECT().GetCluster(mock.Anything, mock.Anything).RunAndReturn(
		func(_ context.Context, server string) (*v1alpha1.Cluster, error) {
			for _, cluster := range clusters {
...
func TestUpdateCluster_NoFieldsPaths(t *testing.T) {
	...
	db.EXPECT().UpdateCluster(mock.Anything, mock.MatchedBy(func(c *v1alpha1.Cluster) bool {
		updated = c
		return true
...
func TestUpdateCluster_FieldsPathSet(t *testing.T) {
	db := &dbmocks.ArgoDB{}
	var updated *v1alpha1.Cluster
	db.EXPECT().GetCluster(mock.Anything, "https://127.0.0.1").Return(&v1alpha1.Cluster{
		Name:       "minikube",
		Server:     "https://127.0.0.1",
		Namespaces: []string{"default", "kube-system"},
	}, nil)
