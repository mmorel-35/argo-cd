...
func (_c *Dependencies_GetHydratorCommitMessageTemplate_Call) RunAndReturn(run func(context.Context) (string, error)) *Dependencies_GetHydratorCommitMessageTemplate_Call {
	_c.Call.Return(run)
	return _c
}
