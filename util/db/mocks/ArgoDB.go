...
func (_c *ArgoDB_GetProjectRepositories_Call) RunAndReturn(run func(context.Context, string) ([]*v1alpha1.Repository, error)) *ArgoDB_GetProjectRepositories_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *ArgoDB_GetProjectWriteRepositories_Call) RunAndReturn(run func(context.Context, string) ([]*v1alpha1.Repository, error)) *ArgoDB_GetProjectWriteRepositories_Call {
	_c.Call.Return(run)
	return _c
}
