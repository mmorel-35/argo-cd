...
func TestGetConfigMapByName(t *testing.T) {
	t.Run("data is never nil", func(t *testing.T) {
		...
		cm, err := settingsManager.GetConfigMapByName(ctx, common.ArgoCDConfigMapName)
		require.NoError(t, err)
	...
	t.Run("cannot update informer value", func(t *testing.T) {
		ctx := t.Context()
		_, settingsManager := fixtures(nil)
		cm1, err := settingsManager.GetConfigMapByName(ctx, common.ArgoCDConfigMapName)
		require.NoError(t, err)
		cm1.Data["test"] = "invalid"
		cm2, err := settingsManager.GetConfigMapByName(ctx, common.ArgoCDConfigMapName)
		require.NoError(t, err)
...
func TestGetSecretByName(t *testing.T) {
	t.Run("data is never nil", func(t *testing.T) {
		...
		secret, err := settingsManager.GetSecretByName(ctx, common.ArgoCDSecretName)
		require.NoError(t, err)
	...
	t.Run("cannot update informer value", func(t *testing.T) {
		ctx := t.Context()
		_, settingsManager := fixtures(nil)
		s1, err := settingsManager.GetSecretByName(ctx, common.ArgoCDSecretName)
		require.NoError(t, err)
		s1.Data["test"] = []byte("invalid")
		s2, err := settingsManager.GetSecretByName(ctx, common.ArgoCDSecretName)
		require.NoError(t, err)
...
func TestGetResourceFilter(t *testing.T) {
	...
	filter, err := settingsManager.GetResourcesFilter(ctx)
	require.NoError(t, err)
...
func TestInClusterServerAddressEnabled(t *testing.T) {
	...
	argoCDCM, err := settingsManager.getConfigMap(ctx)
	require.NoError(t, err)
...
func TestInClusterServerAddressEnabledByDefault(t *testing.T) {
	...
	settingsManager := NewSettingsManager(kubeClient, "default")
	settings, err := settingsManager.GetSettings(ctx)
	require.NoError(t, err)
...
func TestGetTrackingMethod(t *testing.T) {
	...
	ctx := t.Context()
		...
		label, err := settingsManager.GetTrackingMethod(ctx)
		require.NoError(t, err)
...
func TestGetInstallationID(t *testing.T) {
	...
	id, err := settingsManager.GetInstallationID(ctx)
	require.NoError(t, err)
...
func TestApplicationFineGrainedRBACInheritanceDisabledDefault(t *testing.T) {
	ctx := t.Context()
	_, settingsManager := fixtures(nil)
	flag, err := settingsManager.ApplicationFineGrainedRBACInheritanceDisabled(ctx)
	require.NoError(t, err)
	assert.True(t, flag)
}
...
func TestGetIsIgnoreResourceUpdatesEnabled(t *testing.T) {
	ctx := t.Context()
	_, settingsManager := fixtures(nil)
	ignoreResourceUpdatesEnabled, err := settingsManager.GetIsIgnoreResourceUpdatesEnabled(ctx)
	require.NoError(t, err)
...
func TestGetResourceCompareOptions(t *testing.T) {
	// ignoreAggregatedRules is true
	{
		...
		compareOptions, err := settingsManager.GetResourceCompareOptions(ctx)
		require.NoError(t, err)
...
func TestSettingsManager_GetKustomizeBuildOptions(t *testing.T) {
	t.Run("Empty", func(t *testing.T) {
		...
		settings, err := settingsManager.GetKustomizeSettings(ctx)
	...
	t.Run("Set", func(t *testing.T) {
		...
		options, err := settingsManager.GetKustomizeSettings(ctx)
	...
	t.Run("Kustomize settings per-version", func(t *testing.T) {
		...
		got, err := settingsManager.GetKustomizeSettings(ctx)
...
func TestGetGoogleAnalytics(t *testing.T) {
	...
	ga, err := settingsManager.GetGoogleAnalytics(ctx)
	require.NoError(t, err)
...
func TestSettingsManager_GetHelp(t *testing.T) {
	t.Run("Default", func(t *testing.T) {
		ctx := t.Context()
		_, settingsManager := fixtures(nil)
		h, err := settingsManager.GetHelp(ctx)
		require.NoError(t, err)
	...
	t.Run("SetOnlyChatUrl", func(t *testing.T) {
		...
		h, err := settingManager.GetHelp(ctx)
		require.NoError(t, err)
		assert.Equal(t, "foo", h.ChatURL)
...
func TestSettingsManager_GetSettings(t *testing.T) {
	t.Run("UserSessionDurationNotProvided", func(t *testing.T) {
		...
		settingsManager := NewSettingsManager(kubeClient, "default")
		s, err := settingsManager.GetSettings(ctx)
		require.NoError(t, err)
...
func Test_GetTLSConfiguration(t *testing.T) {
	...
	t.Run("Does not parse TLS cert key pair on cache hit", func(t *testing.T) {
		...
		_, err := settingsManager.GetSettings(ctx)
		require.NoError(t, err)
...
func TestGetEnableManifestGeneration(t *testing.T) {
	...
	for i := range testCases {
		...
		t.Run(tc.name, func(t *testing.T) {
			...
			enableManifestGeneration, err := settingsManager.GetEnabledSourceTypes(ctx)
			require.NoError(t, err)
...
func TestGetHelmSettings(t *testing.T) {
	...
	for i := range testCases {
		...
		t.Run(tc.name, func(t *testing.T) {
			...
			helmSettings, err := settingsManager.GetHelmSettings(ctx)
			require.NoError(t, err)
...
func TestIsImpersonationEnabled(t *testing.T) {
	...
	kubeClient := fake.NewClientset()
	settingsManager := NewSettingsManager(kubeClient, "default")
	featureFlag, err := settingsManager.IsImpersonationEnabled(ctx)
...
func TestSettingsManager_GetHideSecretAnnotations(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			keys := settingsManager.GetSensitiveAnnotations(ctx)
...
func TestSettingsManager_GetAllowedNodeLabels(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			keys := settingsManager.GetAllowedNodeLabels(ctx)
			assert.Len(t, keys, len(tt.output))
			assert.Equal(t, tt.output, keys)
		})
	}
